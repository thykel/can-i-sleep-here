...
ActiveRecord::Schema[8.1].define(version: 2026_01_12_234316) do
  ...
  create_table "public.country_boundaries", force: :cascade do |t|
  ...
  create_table "public.forest_areas", force: :cascade do |t|
    t.datetime "created_at", null: false
  ...
  create_table "public.military_areas", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.st_polygon "geometry", geographic: true
  ...
  create_table "public.protected_areas", force: :cascade do |t|
